...
const (
	...
	errMsgNameIsTaken  = "пользователь с таким именем уже существует"
)
...
var (
	...
	ErrNameIsTaken  = errors.New(errMsgNameIsTaken)  // ErrNameIsTaken сигнальная ошибка в случае дублирования email.
)
